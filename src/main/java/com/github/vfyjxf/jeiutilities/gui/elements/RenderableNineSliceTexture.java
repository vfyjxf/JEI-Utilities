...
/**
 * Based on {@link mezz.jei.gui.elements.DrawableNineSliceTexture}
 */
public class RenderableNineSliceTexture {
    ...
    public RenderableNineSliceTexture(SpritesManager spritesManager, ResourceLocation location, int width, int height, int left, int right, int top, int bottom) {
