package dev.vfyjxf.jeiutilities.ui.common;
...
import dev.vfyjxf.jeiutilities.ui.bookmark.AdvancedBookmarkOverlay;
...
public class GuiInputHandler {
    ...
    public void onKeyPressed(GuiScreenEvent.KeyboardInputEvent.Post event) {
        ...
        boolean shouldNotHandleKey = !shouldHandleInput ||
                ...
                JeiUtilitiesPlugin.ingredientListOverlay.hasKeyboardFocus();
