package dev.vfyjxf.jeiutilities.ui.history;

import dev.vfyjxf.jeiutilities.config.JeiUtilitiesConfig;
import dev.vfyjxf.jeiutilities.config.SplittingMode;
    ...
    public void addHistoryIngredient(Object value) {
        if (value != null) {
            ...
            IIngredientListElement<?> ingredient = IngredientListElement.create(
                    normalized,
                    JeiUtilitiesPlugin.ingredientRegistry.getIngredientHelper(normalized),
                    JeiUtilitiesPlugin.ingredientRegistry.getIngredientRenderer(normalized),
                    ForgeModIdHelper.getInstance(),
                    JeiUtilitiesPlugin.ORDER_TRACKER.getOrderIndex(normalized, JeiUtilitiesPlugin.ingredientRegistry.getIngredientHelper(normalized))
            );
